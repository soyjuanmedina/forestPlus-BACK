...
@AllArgsConstructor
@NoArgsConstructor
public class PlannedPlantationRequest {

    @Schema(description = "ID del terreno asociado (opcional)")
    private Long landId;

    @Schema(description = "Fecha prevista de la plantación", required = true)
    private LocalDate plannedDate;

    @Schema(description = "Fecha efectiva de la plantación (opcional)")
    private LocalDate effectiveDate;

    @Schema(description = "Cantidad mínima de árboles a plantar", required = true)
